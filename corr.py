...
for a in range(1,13):
    dataFromCSV = list(csv.reader(open("C:/Users/Yekta/Desktop/stajvol3/573x96/row/row"+str(a)+".csv")))
    ...
    with open("C:/Users/Yekta/Desktop/stajvol3/573x96/corr/corr"+str(a)+".csv", 'w', newline='') as myfile:
